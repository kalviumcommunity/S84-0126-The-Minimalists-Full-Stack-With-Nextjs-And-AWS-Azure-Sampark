...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const apiUrl = buildApiUrl('/api/auth/signup');
      ...
      if (!contentType || !contentType.includes('application/json')) {
        throw new Error('Backend is not responding correctly. Please ensure the backend is deployed and VITE_API_URL is set correctly.');
      }
